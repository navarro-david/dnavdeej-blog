...
export const gradient = {
  ...
  leftToRight: `linear-gradient(-45deg, ${colors.background.light}, ${colors.background.dark})`,
  // eslint-disable-next-line
  rightToLeft: `linear-gradient(45deg, ${colors.background.light}, ${colors.background.dark})`,
};
...
export const theme = {
  ...
  fontFamily: {
    // eslint-disable-next-line
    body: `Roboto, Open Sans,-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'`,
    // eslint-disable-next-line
    heading: `Poppins, Candal, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'`,
  },
  layout: {
    article: '46rem',
    base: '70rem',
